...
// Code here
const getUserById = (arrUser, id, callback) => {
...
const findProgrammer = (arrObj) => {
  const arrToObj = arrObj.filter(search => search.job === `programmer`)
  return arrToObj[0]
}
////////// PROBLEM 12 //////////
...
orderTotals = orders.map((element) => element = element.price*(1 +element.tax))
/// /////// PROBLEM 13 //////////
